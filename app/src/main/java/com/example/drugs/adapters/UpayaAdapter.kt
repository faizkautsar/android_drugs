...
class UpayaAdapter (private var upayas: MutableList<Upaya>, private val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UpayaAdapter.ViewHolder {
        return UpayaAdapter.ViewHolder(
    ...
    override fun onBindViewHolder(holder: UpayaAdapter.ViewHolder, position: Int) =
