...
class PeraturanAdapter(private var hukums: MutableList<Hukum>, private val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PeraturanAdapter.ViewHolder {
        return PeraturanAdapter.ViewHolder(
    ...
    override fun onBindViewHolder(holder: PeraturanAdapter.ViewHolder, position: Int) =
